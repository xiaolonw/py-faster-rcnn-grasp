...
if __name__ == '__main__':
    ...
    prototxt = '/nfs.yoda/xiaolonw/grasp/py-faster-rcnn-grasp/models/grasp_voc/VGG_CNN_M_1024/faster_rcnn_end2end/test.prototxt'
    caffemodel = '/nfs.yoda/xiaolonw/grasp/py-faster-rcnn-grasp/output/faster_rcnn_end2end/grasp_images_2015_trainval/vgg_cnn_m_1024_faster_rcnn_iter_70000.caffemodel'
    ...
    # matches on friends
    detlist = '/nfs.yoda/xiaolonw/grasp/results/test_imgs.txt' 
    jpgdir  = '/nfs.yoda/xiaolonw/grasp/results/test_imgs/'
    savedir = '/nfs.yoda/xiaolonw/grasp/results/det_results/'
