...
class grasp_voc(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, 'grasp_images_' + year + '_' + image_set)
        self._year = year
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join('/scratch/xiaolonw', 'grasp_data')
    ...
    def _load_mcg_roidb(self, gt_roidb):
        filename = os.path.abspath(os.path.join('data', 'grasp_voc_mcg_boxes' + '.mat'))
...
if __name__ == '__main__':
    d = datasets.grasp_voc('trainval', '2007')
    # res = d.roidb
