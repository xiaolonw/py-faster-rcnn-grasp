...
class nyud3_voc(imdb):
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join('/scratch/xiaolonw', 'nyud3')
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_nyud3_annotation(index)
    ...
    def _load_mcg_roidb(self, gt_roidb):
        filename = os.path.abspath(os.path.join('data', 'nyud3_mcg_boxes' + '.mat'))
    ...
    def _load_nyud3_annotation(self, index):
        """
...
if __name__ == '__main__':
    d = datasets.nyud3_voc('trainval', '2007')
    # res = d.roidb
